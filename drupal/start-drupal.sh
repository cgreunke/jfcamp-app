...
# falls vorhanden – fehlertolerant
if [ -f "${WEB_ROOT}/modules/custom/jfcamp_api/scripts/ensure_displays.php" ]; then
  vendor/bin/drush php:script "${WEB_ROOT}/modules/custom/jfcamp_api/scripts/ensure_displays.php" || true
fi
