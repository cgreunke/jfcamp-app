...
/**
 * Baut Standard-Form- und View-Displays für unsere Bundles
 * und hängt vorhandene Felder mit passenden Widgets/Formattern ein.
 * Idempotent: beliebig oft ausführbar.
 *
 * Wichtig: Feldliste entspricht exakt den in start-drupal.sh (Schritt 7) angelegten Feldern.
 */
...
print "Displays repariert (Reserve-Script)\n";
