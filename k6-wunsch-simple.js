...
export default function () {
  ...
  const wuensche = pickN(workshops, MAX_WISHES)
  ...
  if (res.status === 200) t_ok.add(res.timings.duration)  // <- neu
...
export function handleSummary(data){ return { 'summary.json': JSON.stringify(data, null, 2) } }
